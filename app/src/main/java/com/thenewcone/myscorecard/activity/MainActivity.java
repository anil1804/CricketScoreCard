...
public class MainActivity extends AppCompatActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.btnLimitedOvers).setOnClickListener(this);
	...
	public void onClick(View view) {
		switch(view.getId()) {
			case R.id.btnLimitedOvers :
				Intent loIntent = new Intent(this, LimitedOversScorecardActivity.class);
				startActivity(loIntent);
				break;
			case R.id.btnTest:
				Intent testIntent = new Intent(this, TestCricketScorecardActivity.class);
